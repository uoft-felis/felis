...
struct Ycsb {
  ...
  // static constexpr auto kIndexArgs = std::make_tuple(HashKey, 16777215, true);
  ...
  // using IndexBackend = felis::HashtableIndex; // shirley: if HashtableIndex, then change index_info size to 72.
