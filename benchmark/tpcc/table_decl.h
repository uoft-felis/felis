...
FIELD(sql::inline_str_fixed<2>  , c_credit)       ;
...
FIELD(sql::inline_str_fixed<2>  , c_state)        ;
FIELD(sql::inline_str_fixed<9>  , c_zip)          ;
FIELD(sql::inline_str_fixed<16> , c_phone)        ;
FIELD(uint32_t                  , c_since)        ;
FIELD(sql::inline_str_fixed<2>  , c_middle)       ;
FIELD(sql::inline_str_16<500>   , c_data)         ;
VALUES(CustomerValue);

FIELD(uint32_t,  c_w_id) ;
FIELD(uint32_t,  c_d_id) ;
FIELD(sql::inline_str_fixed<16>, c_last);
FIELD(sql::inline_str_fixed<16>, c_first);
...
FIELD(sql::inline_str_fixed<2> , d_state)     ;
FIELD(sql::inline_str_fixed<9> , d_zip)       ;
...
FIELD(sql::inline_str_fixed<12> , no_dummy);
...
FIELD(sql::inline_str_fixed<24> , s_dist_01) ;
FIELD(sql::inline_str_fixed<24> , s_dist_02) ;
FIELD(sql::inline_str_fixed<24> , s_dist_03) ;
FIELD(sql::inline_str_fixed<24> , s_dist_04) ;
FIELD(sql::inline_str_fixed<24> , s_dist_05) ;
FIELD(sql::inline_str_fixed<24> , s_dist_06) ;
FIELD(sql::inline_str_fixed<24> , s_dist_07) ;
FIELD(sql::inline_str_fixed<24> , s_dist_08) ;
FIELD(sql::inline_str_fixed<24> , s_dist_09) ;
FIELD(sql::inline_str_fixed<24> , s_dist_10) ;
...
FIELD(sql::inline_str_fixed<2>  , w_state)    ;
FIELD(sql::inline_str_fixed<9>  , w_zip)      ;
