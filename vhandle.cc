...
void BaseVHandle::InitPool()
{
  ...
  size_t VHandlePoolSize = ((size_t)1024)*1024*1024*5; // ((size_t)1536) * 1024 * 1024; // 1536 MB for tpcc. 256 MB for ycsb // ((size_t)1024)*1024*1024*2; // 2 GB for now
  ...
  void *fixed_mmap_addr = (void *) 0x7FC000000000; // nullptr;
